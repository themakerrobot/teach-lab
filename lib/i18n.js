...
const GL_I18N = {
  ...
  // ── 학습실: 종류 ──
  '종류': 'Kinds',
  '무엇을 맞히고 싶나요?': 'What do you want it to guess?',
  ...
  '찍은 사진은 이 컴퓨터 밖으로 나가지 않아요': 'Your pictures never leave this computer',
  ...
  '파이썬은 모델과 실행 코드를 같이 받아요. 압축을 풀고 pip install teachlab 한 뒤 python predict.py 사진.jpg 로 바로 돌아가요.':
    'The Python export bundles the model with runnable code. Unzip it, run pip install teachlab, then python predict.py photo.jpg.',
  '알아 두기': 'Good to know',
