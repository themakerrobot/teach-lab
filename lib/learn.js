...
import { loadEmbedder, cropTo, thumbFrom, EMBEDDER, accentColor, accentRgba } from './embedder.js';
...
// 웹캠 프레임은 화면의 미리보기 캔버스에 바로 그린다 — 보이는 것이 곧 학습 입력이다.
const camCv = $('camCv');
...
function loop() {
  ...
  // 웹캠은 거울(EMBEDDER.mirror) — TM 의 Webcam(w, h, flip=true) 과 같다
