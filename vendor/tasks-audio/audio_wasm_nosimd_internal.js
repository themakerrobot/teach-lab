...
function findWasmBinary() {
  return locateFile("audio_wasm_nosimd_internal.wasm");
}
...
function assignWasmExports(wasmExports) {
  _configureAudio = Module["_configureAudio"] = wasmExports["Tb"];
  _addAudioToInputStream = Module["_addAudioToInputStream"] = wasmExports["Vb"];
  _free = Module["_free"] = wasmExports["Wb"];
  _malloc = Module["_malloc"] = wasmExports["Xb"];
  _mediapipeLoggerGetEncodedApiKey = Module["_mediapipeLoggerGetEncodedApiKey"] = wasmExports["Yb"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["Zb"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["_b"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["$b"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["ac"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["bc"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["cc"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["dc"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["ec"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["fc"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["gc"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["hc"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["ic"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["jc"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["kc"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["lc"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["mc"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["nc"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["oc"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["pc"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["qc"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["rc"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["sc"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["tc"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["uc"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["vc"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["wc"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["xc"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["yc"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["zc"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["Ac"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["Bc"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["Cc"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["Dc"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["Ec"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Fc"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Gc"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Hc"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["Ic"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["Jc"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["Kc"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["Lc"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["Mc"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["Nc"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["Oc"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["Pc"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["Qc"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["Rc"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["Sc"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["Tc"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["Uc"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["Vc"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["Wc"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["Xc"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["Yc"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["Zc"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["_c"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["$c"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["ad"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["bd"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["cd"];
  _emwgpuCreateBindGroup = wasmExports["dd"];
  _emwgpuCreateBindGroupLayout = wasmExports["ed"];
  _emwgpuCreateCommandBuffer = wasmExports["fd"];
  _emwgpuCreateCommandEncoder = wasmExports["gd"];
  _emwgpuCreateComputePassEncoder = wasmExports["hd"];
  _emwgpuCreateComputePipeline = wasmExports["id"];
  _emwgpuCreateExternalTexture = wasmExports["jd"];
  _emwgpuCreatePipelineLayout = wasmExports["kd"];
  _emwgpuCreateQuerySet = wasmExports["ld"];
  _emwgpuCreateRenderBundle = wasmExports["md"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["nd"];
  _emwgpuCreateRenderPassEncoder = wasmExports["od"];
  _emwgpuCreateRenderPipeline = wasmExports["pd"];
  _emwgpuCreateSampler = wasmExports["qd"];
  _emwgpuCreateSurface = wasmExports["rd"];
  _emwgpuCreateTexture = wasmExports["sd"];
  _emwgpuCreateTextureView = wasmExports["td"];
  _emwgpuCreateAdapter = wasmExports["ud"];
  _emwgpuImportBuffer = wasmExports["vd"];
  _emwgpuCreateDevice = wasmExports["wd"];
  _emwgpuCreateQueue = wasmExports["xd"];
  _emwgpuCreateShaderModule = wasmExports["yd"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["zd"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["Ad"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["Bd"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["Cd"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["Dd"];
  _processGl = Module["_processGl"] = wasmExports["Ed"];
  _process = Module["_process"] = wasmExports["Fd"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["Gd"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["Hd"];
  _waitUntilIdle = Module["_waitUntilIdle"] = wasmExports["Id"];
  _closeGraph = Module["_closeGraph"] = wasmExports["Jd"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["Kd"];
  _emscripten_builtin_memalign = wasmExports["Md"];
  __emscripten_tempret_set = wasmExports["Nd"];
  __emscripten_stack_restore = wasmExports["Od"];
  __emscripten_stack_alloc = wasmExports["Pd"];
  _emscripten_stack_get_current = wasmExports["Qd"];
  ...
  _kVersionStampBuildFdoProfileChangelistStr = Module["_kVersionStampBuildFdoProfileChangelistStr"] = wasmExports["Fb"].value;
  _kVersionStampBuildMemprofProfileChangelistStr = Module["_kVersionStampBuildMemprofProfileChangelistStr"] = wasmExports["Gb"].value;
  ...
  __indirect_function_table = wasmTable = wasmExports["Ub"];
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = wasmExports["Ld"].value;
}

var wasmImports = {
  /** @export */ gb: JsOnEmptyPacketListener,
  /** @export */ P: JsOnSimpleListenerBinaryArray,
  ...
  /** @export */ Ua: JsWrapErrorListenerInternal,
  /** @export */ Ta: JsWrapLoggingHelpers,
  /** @export */ a: JsWrapSimpleListeners,
  /** @export */ O: UseBottomLeftGpuOrigin,
  /** @export */ W: __asyncjs__mediapipe_map_buffer_jspi,
  /** @export */ Sa: ___syscall_dup,
  /** @export */ Ra: ___syscall_faccessat,
  /** @export */ N: ___syscall_fcntl64,
  /** @export */ Qa: ___syscall_fstat64,
  /** @export */ ca: ___syscall_ftruncate64,
  /** @export */ Pa: ___syscall_ioctl,
  /** @export */ Oa: ___syscall_lstat64,
  /** @export */ Na: ___syscall_newfstatat,
  /** @export */ M: ___syscall_openat,
  /** @export */ Ma: ___syscall_stat64,
  /** @export */ Ha: __abort_js,
  /** @export */ $: __gmtime_js,
  /** @export */ _: __localtime_js,
  /** @export */ Z: __mktime_js,
  /** @export */ Y: __mmap_js,
  /** @export */ X: __munmap_js,
  /** @export */ Ga: __tzset_js,
  /** @export */ ba: _clock_time_get,
  /** @export */ Fa: custom_emscripten_dbgn,
  /** @export */ Ea: _emscripten_asm_const_int,
  /** @export */ t: _emscripten_errn,
  /** @export */ Da: _emscripten_get_heap_max,
  /** @export */ b: _emscripten_get_now,
  /** @export */ Ca: _emscripten_has_asyncify,
  /** @export */ Ba: _emscripten_outn,
  /** @export */ Aa: _emscripten_pc_get_function,
  /** @export */ za: _emscripten_resize_heap,
  /** @export */ K: _emscripten_stack_snapshot,
  /** @export */ ya: _emscripten_stack_unwind_buffer,
  /** @export */ xa: _emscripten_webgl_create_context,
  /** @export */ wa: _emscripten_webgl_destroy_context,
  /** @export */ va: _emscripten_webgl_get_context_attributes,
  /** @export */ i: _emscripten_webgl_get_current_context,
  /** @export */ ua: _emscripten_webgl_make_context_current,
  /** @export */ ta: _emwgpuBufferDestroy,
  /** @export */ c: _emwgpuDelete,
  /** @export */ sa: _emwgpuDeviceCreateBuffer,
  /** @export */ ra: _emwgpuDeviceDestroy,
  /** @export */ La: _environ_get,
  ...
  /** @export */ I: _glAttachShader,
  /** @export */ qa: _glBindAttribLocation,
  ...
  /** @export */ H: _glDeleteFramebuffers,
  /** @export */ ma: _glDeleteProgram,
  /** @export */ G: _glDeleteShader,
  /** @export */ l: _glDeleteSync,
  /** @export */ F: _glDeleteTextures,
  /** @export */ E: _glDetachShader,
  /** @export */ D: _glDisableVertexAttribArray,
  /** @export */ la: _glDrawArrays,
  /** @export */ C: _glEnableVertexAttribArray,
  /** @export */ B: _glFenceSync,
  /** @export */ k: _glFinish,
  /** @export */ q: _glFramebufferTexture2D,
  /** @export */ A: _glGenBuffers,
  /** @export */ ka: _glGenFramebuffers,
  /** @export */ p: _glGenTextures,
  /** @export */ j: _glGetError,
  /** @export */ z: _glGetIntegerv,
  /** @export */ o: _glGetString,
  /** @export */ ja: _glGetUniformLocation,
  /** @export */ ia: _glLinkProgram,
  /** @export */ n: _glPixelStorei,
  /** @export */ y: _glReadPixels,
  /** @export */ ha: _glShaderSource,
  /** @export */ ga: _glTexImage2D,
  /** @export */ d: _glTexParameteri,
  /** @export */ x: _glTexStorage2D,
  /** @export */ fa: _glUniform1i,
  /** @export */ ea: _glUseProgram,
  /** @export */ w: _glVertexAttribPointer,
  /** @export */ da: _glViewport,
  /** @export */ Ja: _proc_exit,
  /** @export */ Ia: _random_get,
  /** @export */ V: _wgpuCommandEncoderCopyTextureToBuffer,
  /** @export */ U: _wgpuCommandEncoderFinish,
  /** @export */ T: _wgpuDeviceCreateCommandEncoder,
  /** @export */ S: _wgpuQueueSubmit,
  /** @export */ R: _wgpuTextureDestroy,
  /** @export */ Q: _wgpuTextureGetFormat
};
